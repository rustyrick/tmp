...
class JFormFieldPtpicker extends JFormField
{

    protected $type = 'Pbtpicker';
    ...
    protected function getInput()
    {
        ...
        $doc->addScriptDeclaration('jQuery(document).ready(function(){jQuery("#'.$this->id.'").timepicker(dtLocalisation);});');
